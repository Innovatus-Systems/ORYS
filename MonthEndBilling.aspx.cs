...
public partial class MonthEndBilling : System.Web.UI.Page
{
    ...
    private void LocalSaving(DataTable dtData)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
            ...
            sbBody.Append("</td></tr>");
            sbBody.Append("<tr><td></td></tr>");
            sbBody.Append("<tr style='font-family:Verdana;font-size:13px;'><td><b>This is an automatically generated mail from <a href='http://www.covaiseniorliving.com/' title='Click here to open ORIS'>Happy Senior</a>, the software for Retirement Communities.</b></td></tr>");
            sbBody.Append("</table>");
            myMail.IsBodyHtml = true;
