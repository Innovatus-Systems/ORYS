                            ...
                            <tr>
                                <td style="width: 62%;">
                                    <table style="width: 100%;">
                                       ...
                                       <%-- <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtRemarks" CssClass="form-control" runat="server" Height="50px" TextMode="MultiLine" ToolTip=" A brief description of the transaction" Width="350px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                    ...
                                    <table>
                                        <tr align="Center">
                                            <td>
                                                <asp:RadioButton ID="rdbResident" AutoPostBack="true" runat="server" Text="Resident" GroupName="G1" Checked="true" OnCheckedChanged="rdbResident_CheckedChanged" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
